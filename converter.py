...
ET.SubElement(remark, 'content').text = 'Generated by Geosetta'
...
ET.SubElement(business_associate_element, 'gml:name').text = 'vdot'
...
ET.SubElement(borehole, 'totalMeasuredDepth', {'uom': 'ft'}).text = '8.7'
